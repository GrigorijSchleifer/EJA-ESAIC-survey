...
survey_fragments %>% 
    ...
    mutate(risc_proportion = as.factor(value/sum(value))) %>% 
    mutate(risc_proportion = fct_reorder(risc_proportion, value)) %>% 
    ggplot(aes(x = risc_proportion, y = value, fill = risc_proportion)) +
