...
GDP_accordance_simple$when_simple[GDP_accordance_simple$when_simple == "day_prior_or_less"] <- "=24"

GDP_accordance_simple <- GDP_accordance_simple %>% 
    table()

GDP_accordance_simple_test <- GDP_accordance_simple[c(1,3,4),] %>% 
# Chi-Square Statistics
chisq.test()

# Legal requirenments for simple
corrplot(
    t(GDP_accordance_simple_test$residuals),
    is.corr = FALSE,
    tl.col = "black",
    tl.srt = 0,
    tl.cex = 3,
...
# combine both 24h entries
GDP_accordance_complex$when_simple[GDP_accordance_complex$when_simple == "day_prior_or_less"] <- "=24"

GDP_accordance_complex <- GDP_accordance_complex %>% 
    table()

GDP_accordance_complex_test <- GDP_accordance_complex[c(1,3,4),] %>% 
# Chi-Square Statistics
chisq.test()

# Legal requirenments for simple
corrplot(
    t(GDP_accordance_complex_test$residuals),
    is.corr = FALSE,
    tl.col = "black",
    tl.srt = 0,
    tl.cex = 3,
