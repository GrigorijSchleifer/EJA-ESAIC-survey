...
survey_data %>% 
    group_by(GDP) %>% 
    table(survey_data$"When do you need to obtain Informed consent for elective surgery based on legal requirements (for simple procedures, low risk patients).")
```
