...
tech_internet_GDP <- survey_dt_associations %>%
    ...
    add_column(Answer = c("Yes", "No"),
               Question = rep("tech_internet", 2))


#              GDP_PER_CAPITA
# tech_internet High_GDP_PC Middle_GDP_PC Low_GDP_PC
#           Yes          80            64          5
#           No          203           156         89
...
corrplot(tech_internet_GDP$residuals, is.cor = FALSE)
